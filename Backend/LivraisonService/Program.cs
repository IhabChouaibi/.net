...
using LivraisonService.Services;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "LivraisonService API",
        Version = "v1",
        Description = "Gestion des adresses et statuts de livraison."
    });
...
builder.Services.AddScoped<IAdresseLivraisonRepository, AdresseLivraisonRepository>();
builder.Services.AddScoped<IStatutLivraisonRepository, StatutLivraisonRepository>();
builder.Services.AddScoped<ILivraisonService, LivraisonCrudService>();
...
{
    var dbContext = scope.ServiceProvider.GetRequiredService<LivraisonDbContext>();
