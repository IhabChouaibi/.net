...
using LivreurService.Repositories;
using LivreurService.Services;
...
builder.Services.AddDbContext<LivreurDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));

builder.Services.AddScoped(typeof(IGenericRepository<>), typeof(GenericRepository<>));
builder.Services.AddScoped<ILivreurRepository, LivreurRepository>();
builder.Services.AddScoped<ILivreurService, LivreurCrudService>();
...
app.UseExceptionHandler(errorApp =>
{
    errorApp.Run(async context =>
    {
        ...
        logger.LogError(feature?.Error, "Unhandled exception in LivreurService.");
...
{
    var dbContext = scope.ServiceProvider.GetRequiredService<LivreurDbContext>();
