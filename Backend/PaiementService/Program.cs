...
using PaiementService.Repositories;
using PaiementService.Services;
...
builder.Services.AddScoped<IPaiementService, PaiementCrudService>();
...
app.UseExceptionHandler(errorApp =>
{
    errorApp.Run(async context =>
    {
        ...
        logger.LogError(feature?.Error, "Unhandled exception in PaiementService.");
...
{
    var dbContext = scope.ServiceProvider.GetRequiredService<PaiementDbContext>();
